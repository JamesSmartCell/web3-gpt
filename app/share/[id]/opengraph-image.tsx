...
// const interRegular = fetch(new URL("../../../assets/fonts/Inter-Regular.woff", import.meta.url)).then((res) =>
//   res.arrayBuffer()
// )

// const interBold = fetch(new URL("../../../assets/fonts/Inter-Bold.woff", import.meta.url)).then((res) =>
//   res.arrayBuffer()
// )
